...
export async function generateMetadata({ params, searchParams }) {
  ...
  if (imgRaw) {
    const transformed = String(imgRaw).replace('/object/public/', '/render/image/public/')
...
export default async function UniversityBridgePage({ params }) {
  ...
  return (
    <div style={{ textAlign: 'center', marginTop: '40vh', fontFamily: 'system-ui, sans-serif' }}>
      ...
      <Script id="uni-share-bridge" strategy="afterInteractive" dangerouslySetInnerHTML={{ __html: inline }} />
    </div>
  )
}
