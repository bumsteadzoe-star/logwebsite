...
export async function renderOgImageBuffer(input) {
  ...
  // `attention` = smart crop (luminance / saturation / skin-tone cues). Avoids dead-centre crops
  // that leave subjects hugging one edge when the photo is tall or wide vs 1.91:1 OG ratio.
